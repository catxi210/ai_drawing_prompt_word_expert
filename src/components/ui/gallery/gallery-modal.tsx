      ...
      {isOpen &&
        createPortal(
          <AnimatePresence>
            ...
            >
              <motion.div className="relative cursor-grab rounded-full border border-solid border-white/20 bg-white/10 p-2 shadow-lg backdrop-blur-xl active:cursor-grabbing">
